...
const MyApllication = dynamic(() => import('@/core/component/Layout/scoreCreditCard/myApplications'), {
  ssr: false
})
...
export async function getServerSideProps(context) {
  try {
    ...
    const [data1, data2, data4] = await Promise.all([response1, response2, metaApiCall]).then(

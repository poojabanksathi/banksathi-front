...
const BankingPage = ({ businessCategorydata, CreditNewsList }) => {
  return (
    <>
      <div>
        ...
        {CreditNewsList && (
          <div className='bg-[#F4F8FB] h-auto'>
            <CommonBreadCrumbComponent link1='/banking' link1Name='Banking' link2Name='News' title='Banking Blogs' />
            <CreditNews CreditNewsList={CreditNewsList} pageTitle='Banking Blogs' bankingPage={true} />
          </div>
        )}

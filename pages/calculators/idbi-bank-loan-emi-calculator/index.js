        ...
        <>
            <div>
                ...
                <div className='bg-[#F4F8FB] h-auto'>
                    <BredcrumbCalculator />
                    <PersonalLoanCalculator metaData={businessmetaheadtag} loanIconSrc={HomeRupee} calculatorName={'IDBI Bank Personal Loan EMI Calculator'} info={'Plan Your Loans, Control Your Future'} loanname={'idbi-bank-loan'} />
                    <FAQ faqdata={faqdata} />
                </div>

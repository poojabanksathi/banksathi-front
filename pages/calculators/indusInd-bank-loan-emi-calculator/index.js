        ...
        <>
            <div>
                ...
                <div className='bg-[#F4F8FB] h-auto'>
                    <BredcrumbCalculator />
                    <PersonalLoanCalculator metaData={businessmetaheadtag} loanIconSrc={HomeRupee} calculatorName={'IndusInd Bank Personal Loan EMI Calculator'} info={'Plan Your Loans, Control Your Future'} loanname={'indusInd-bank-loan'} />
                    <FAQ faqdata={faqdata} />
                </div>

...
import starImage from '../../../../../public/assets/Star 41.svg'
import EmiSliderChart from '../LoanCalculatorEmiDetails/EmiSliderChart'
import EmiSliderRightPanel from '../LoanCalculatorEmiDetails/EmiSliderRightPanel'
import ParagraphBanner from '@/core/component/Layout/CategoryParagraphBanner'
...
const CreditNewsOffer = dynamic(
  () => import('../../../../../core/component/Layout/CreditNews/CreditScoreCard/CreditNewsOffer'),
  { ssr: false }
)
    ...
    <div className='container h-full  mx-auto max-[991px]:max-w-full pt-[30px] pb-[40px] max-[834px]:py-[35px] max-[576px]:py-[52px] max-[479px]:py-[20px] max-[1024px]:px-8 max-[479px]:px-0 max-[375px]:px-0 max-[320px]:px-0'>
      ...
      <div className='flex max-md:block text-center gap-[20px]'>
          <div className='max-sm:flex max-lg:justify-center'>
            <Image src={CarLoan} width={85} height={85} alt='loan_icon' className='mx-auto' />
          </div>
          <div>
            <h2 className='text-[36px] max-sm:text-[20px] text-[#212529] font-semibold'>Car Loan Calculator</h2>
            <p className='text-[18px] max-sm:text-[16px] text-[#49D49D] font-semibold'>Drive Your Dream, Manage Your Budget</p>
          </div>
        </div>
        <div className='grid grid-cols-12 mt-[35px] '>
          ...
          { metaData&& <div className='max-[320px]:px-2'>

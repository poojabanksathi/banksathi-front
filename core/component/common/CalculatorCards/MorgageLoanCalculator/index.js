    ...
    <div className='container h-full  mx-auto max-[991px]:max-w-full pt-[30px] pb-[40px] max-[834px]:py-[35px] max-[576px]:py-[52px] max-[479px]:py-[20px] max-[1024px]:px-8 max-[479px]:px-0 max-[375px]:px-0 max-[320px]:px-0'>
      ...
      <div className='flex max-md:block max-md:text-center gap-[20px]'>
          <div className='max-sm:flex max-sm:justify-center'>
            <Image src={MorgageLoan} width={85} height={85} alt='loan_icon' className='mx-auto'/>
          </div>
          <div>
            <h2 className='text-[36px] max-sm:text-[20px] text-[#212529] font-semibold'>Mortgage Calculator</h2>
            <p className='text-[18px] max-sm:text-[16px] text-[#49D49D] font-semibold'>Unlock Possibilities, Secure Your Future</p>
          </div>
        </div>

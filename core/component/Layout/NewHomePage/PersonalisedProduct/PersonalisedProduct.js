...
//   const isDesktop = useMemo(() => size?.width >= 768, [size]);

//   const getStartedComp = useMemo(() => (
...
// export default React.memo(PersonalisedProduct);
...
const PersonalisedProduct = () => {
  ...
  const getStartedComp = useMemo(() => (
    <Link href='/credit-cards/recommendation' className='mb-2' prefetch={false}>
      <div
        style={{ minWidth: '190px', minHeight: '56px' }}
        className='head-text text-center bg-[#49D49D] text-[#212529] py-2 pl-2 pr-2 rounded-lg text-lg w-[190px] h-[56px] flex items-center justify-center gap-4'
      >
        <button className='cursor-pointer'>Get Started</button>
        <Image
          src={rightArrow}
      ...
      <div
        style={{ minHeight: '20.80px' }}
        className="text-neutral-800 text-[13px] font-normal font-['Poppins'] leading-[20.80px] md:mt-[30px] mt-[20px]"
      >
        *Note: You don’t need to provide your mobile number to get product suggestions.
      </div>
    </Link>
  ...
  return (
    <>
      <div style={{ minWidth: '23px', minHeight: '23px' }}>
        <Image
          src={'/assets/star-bg-home.svg'}
          height={23}
          width={23}
        ...
        <div className='flex items-center justify-center flex-row gap-x-[30px] max-[768px]:flex-col lg:px-[135px]'>
          <div className='flex flex-col gap-y-[30px] items-start justify-start'>
            <div
              ...
              className="text-neutral-800 text-[40px] max-sm:px-[3px] font-semibold font-['Faktum'] leading-[48px] lg:pt-[90px] max-md:text-[22px] max-md:text-center max-md:leading-[26.4px] max-md:pt-[30px]"
            >
          ...
          <div className='flex flex-row gap-x-[10px] max-md:mt-[24px] max-[768px]:w-full max-[768px]:overflow-x-scroll category-btn-scroll'>
            <div
              style={{ minWidth: '183px', minHeight: '250px' }}
              className='w-[183px] h-[250px] bg-slate-50 rounded-3xl max-md:h-[210px] step-container'
            >
              ...
              <div
                style={{ minHeight: 'normal' }}
                className="text-left px-[20px] pt-[15px] max-md:px-[20px] text-neutral-800 text-[15px] font-medium font-['Poppins'] leading-normal max-md:text-xs"
              >
            ...
            <div
              style={{ minWidth: '183px', minHeight: '250px' }}
              className='w-[183px] h-[250px] max-md:h-[210px] step-container bg-slate-50 rounded-3xl'
            >
              ...
              <div
                style={{ minHeight: 'normal' }}
                className="text-left px-[20px] max-md:px-[20px] pt-[22px] text-neutral-800 text-[15px] leading-normal max-md:text-xs font-medium font-['Poppins']"
              >
                Banksathi’s smart algorithm does the processing
              </div>
            </div>
            ...
            >
              ...
              <div
                style={{ minHeight: 'normal' }}
                className="text-left px-[20px] max-md:px-[20px] pt-[15px] text-neutral-800 text-[15px] font-medium font-['Poppins'] leading-normal max-md:text-xs"
              >
                Get the best product recommendation
              </div>
            </div>

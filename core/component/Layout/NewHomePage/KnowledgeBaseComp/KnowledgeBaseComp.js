...
const KnowledgeBaseComp = memo(({ blogData }) => {
        ...
        <div className='flex flex-col gap-y-[30px]'>
          <div className='flex flex-row justify-between'>
            ...
            <div className='flex flex-row gap-[4px] items-center'>
              ...
              <Image src={greenArrow} width={20} height={20} priority={true} alt='More Blogs' className='h-[20px] w-[20px]'/>
            </div>
          </div>

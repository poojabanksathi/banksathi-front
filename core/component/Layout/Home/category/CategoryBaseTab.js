...
const CategoryTabsHome = dynamic(() => import('@/core/component/common/CategoryTabsHome'), {
  ssr: false
})

const TroubleComp = dynamic(() => import('../../NewHomePage/TroubleComp/TroubleComp'), {
  ssr: false
})
const Content = dynamic(() => import('../content/Content'), {
  ssr: false
})
const TopSellingProducts = dynamic(() => import('../../NewHomePage/TopSellingProducts/TopSellingProducts'), {
  ssr: false
})
...
const CategoryBaseTab = memo(({ businessCategorydata, isDesktop }) => {
  return (
    <>
    <div className='bg-[#F4F8FB]'>
      ...
      <div className='mt-[26px] max-sm:mt-[19px] h-auto'>
        <CategoryTabsHome businessCategorydata={businessCategorydata} isDesktop={isDesktop} />
        <div className="content-wrapper" style={{ minHeight: '72px' }}> 
    <Suspense fallback={<SkeletonLoader />}>
      <Content isDesktop={isDesktop} />
    </Suspense>
  </div>
      </div>
        <div className='lg:mt-[40px] max-sm:mt-0  container mx-auto max-[768px]:px-[12px] max-[768px]:pt-[30px] md:mt-[50px] '>
          <Suspense fallback={<SkeletonLoader />}>
